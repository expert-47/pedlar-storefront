  ...
  return (
    <Box style={{ paddingTop: "40px", paddingBottom: "40px"}}>
      <Grid container item xs={12} sm={12} md={12} lg={12} >
        ...
        <Grid item xs={12} sm={12} md={12} lg={6}>
          <Accordion expanded={expanded === "panel1"} onChange={handleChange("panel1")} sx={styles.acordianMain} style={{borderRadius:'unset'}}>
            <AccordionSummary
          ...
          <Accordion expanded={expanded === "panel2"} onChange={handleChange("panel2")}  sx={styles.acordianMain}>
            ...
            <AccordionDetails>
              <Typography sx={styles.acordianPara}>
                Creators earn a 20% commission on all sales made on their Pedlar store. Brands only pay commision when a
                sale is made.
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion expanded={expanded === "panel3"} onChange={handleChange("panel3")}  sx={styles.acordianMain}>
            ...
            <AccordionDetails>
              <Typography sx={styles.acordianPara}>Nope! It's completely free for both Creators and Brands.</Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion expanded={expanded === "panel4"} onChange={handleChange("panel4")}  sx={styles.acordianMain}>
            ...
            <AccordionDetails>
              <Typography sx={styles.acordianPara}>
                Since Pedlar is an invite only platform, submit an application and our team will get back to you within
                24 hours. Pedlar is excited to partner with Creators with all types of aesthetic and style!
              </Typography>
            </AccordionDetails>
          </Accordion>
          <Accordion expanded={expanded === "panel5"} onChange={handleChange("panel5")}  sx={styles.acordianMain} style={{ borderBottom: '1px solid rgb(28, 27, 31)', borderRadius:'unset',}}>
            <AccordionSummary
            ...
            <AccordionDetails>
              <Typography sx={styles.acordianPara}>Yep, when signing up you can choose your own unique URL.</Typography>
            </AccordionDetails>
          </Accordion>
        </Grid>
      </Grid>
