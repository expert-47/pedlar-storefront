          ...
          <Grid item xs={12} sm={8} md={8} lg={8}>
            <Box sx={styles.scrollSection} id="creator">
              ...
              <Accordion expanded={expanded === "panel3"} onChange={handleChange("panel3")} sx={styles.acordianMain}>
                ...
                <AccordionDetails>
                  <Typography sx={styles.acordianPara}>
                    If you have purchased multiple items from different Brands you will receive separate deliveries. All
                    the products sold through Pedlar will be shipped directly from the brand.
                  </Typography>
                </AccordionDetails>
              </Accordion>
            ...
            <Box sx={styles.scrollSection} id="brand">
              ...
              >
                ...
                <AccordionDetails>
                  <Typography sx={styles.acordianPara}>
                    Returns must be received by the Brand within 14 days of receiving your item. We offer a full refund
                    for full priced items in original, as new condition with their original packaging and tags. Item(s)
                    must not have been worn, washed or altered in any way. Brands have the right to deny any item/s that
                    aren't returned in their original condition.
                  </Typography>
                </AccordionDetails>
              </Accordion>
            </Box>
            <Box sx={styles.scrollSection} id="shopper">
              ...
              <Accordion expanded={expanded === "panel13"} onChange={handleChange("panel13")} sx={styles.acordianMain}>
                ...
                <AccordionDetails>
                  <Typography sx={styles.acordianPara}>
                    If you do not live in Australia, please be aware of any import duties and taxes that may be charged
                    on deliveries to your country. Duties and taxes will be based on the value of the order and the
                    tax-free threshold (if it exists) for goods imported. These charges depend on your country’s import
                    legislation and will not be covered by Pedlar.
                  </Typography>
                </AccordionDetails>
              </Accordion>
            ...
            <Box sx={styles.scrollSection} id="general">
              ...
              <Accordion expanded={expanded === "panel17"} onChange={handleChange("panel17")} sx={styles.acordianMain}>
                ...
                <AccordionDetails>
                  <Typography sx={styles.acordianPara}>
                    Yes, all products listed on Pedlar are priced the same as on the brands website. If a brand changes
                    the price of their products, this will automatically update across Pedlar stores.
                  </Typography>
                </AccordionDetails>
              </Accordion>
              ...
              <Accordion expanded={expanded === "panel20"} onChange={handleChange("panel20")} sx={styles.acordianMain}>
                <AccordionSummary
