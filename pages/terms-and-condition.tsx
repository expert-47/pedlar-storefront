    ...
    <Fragment>
      <Box sx={{ marginLeft: "51px", width: "1109px" }}>
        ...
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "30px" }}>
          ...
          Policy and our Privacy Policy, and any other terms and conditions that appear in or are linked to or from the
          Sites (Terms). These Terms govern your use of, and access to, the Sites.
        </Typography>
        <Typography sx={{ fontSize: "20px", fontWeight: 600, marginTop: "30px" }}>Content</Typography>
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "30px" }}>
          The Sites and their content are subject to copyright, and other intellectual property rights. These rights are
          owned by Pedlar, or in the case of some material, a third party, where the third party has provided permission
          to use the content. You must not otherwise reproduce, transmit (including broadcast), communicate, upload,
          adapt, distribute, sell, modify or publish or otherwise use any of the material from the Site, including code
          and software, audio and video excerpts, except as permitted by statute or with our prior written consent. Our
          Sites includes registered trademarks, and other marks that are otherwise protected by law.
        </Typography>
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "20px" }}>
          ...
          sell, modify or publish or otherwise use any of the material from the Site, including code and software, audio
          and video excerpts, except as permitted by statute or with our prior written consent.
        </Typography>
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "20px" }}>
          Our Sites includes registered trademarks, and other marks that are otherwise protected by law. You may not use
          our trademarks without our written consent or any third party’s trademarks without their consent.
        </Typography>
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "20px" }}>
        ...
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "20px" }}>
          Many of the products and services offered for sale or advertised and much of the information provided via the
          Site are the products, services and information of third parties. These third-party products, services and
          information are not provided or delivered by Pedlar. Further, we may receive fees or commissions from third
          parties for products or services displayed or made available on the Sites or accessible through a link on the
          Sites. You acknowledge and consent to us receiving such fees.
        </Typography>
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "20px" }}>
        ...
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "20px" }}>
          You consent to any act or omission which would otherwise constitute an infringement of your moral rights, and
          if you supply any content in which any third party has moral rights, you must also ensure that the third party
          also consents in the same manner.
        </Typography>
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "20px" }}>
          The license referred to above will survive any termination of these Terms.
        </Typography>
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "20px" }}>
          You represent and warrant to us that you have all necessary rights to grant the licenses and consents set out
          above.
        </Typography>
        <Typography sx={{ fontSize: "20px", fontWeight: 600, marginTop: "30px" }}>Use of Sites</Typography>
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "20px" }}>
          You must not misuse any Site and only use it for lawful purposes. You will not use the Sites (including any of
          Pedlar.store) social media sites for any activities, or post or transmit to or via the Sites any information
          or materials, which:
        </Typography>
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "20px" }}>
          a) Breaches any laws or regulations, infringes a third party’s rights or privacy, or which are contrary to any
        ...
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "20px" }}>
          f) Users, send any spam, unsolicited advertising or promotional material, or attempt to affect the performance
          or functionality of any technology of or accessed through this Site. You represent and warrant that:
        </Typography>
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "20px" }}>
        ...
        <Typography sx={{ fontWeight: 400, fontSize: "16px", marginTop: "20px" }}>
          ...
          complying with the laws in the place where you access the Sites. As the Sites may be accessed in Australia and
          overseas. We make no representations that the Sites comply with the laws (including intellectual property
          laws) of any country outside Australia.
        </Typography>
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          ...
          any termination of your relationship with us or your use of the Platform. To the fullest extent permitted by
          law, the foregoing indemnity will apply regardless of any fault, negligence, or breach of warranty or contract
          of ours and /or our suppliers, affiliates, partners, subsidiaries and employees.
        </Typography>
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          ...
          own Sites may also include social media functions, including user reviews, ratings, forums, and the ability to
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          ...
          by users, including advice or opinions, is the view and responsibility of those users and does not necessarily
          represent our views
        </Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          3) Users must not post or upload any comment, content or link to the Sites (including any social media sites)
          which does not comply with these Terms, including if it is defamatory, harassing, bullying, indecent or
          inflammatory
        </Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          4) We may moderate user-posted content and may remove any content that, in our opinion, is inappropriate.
          While we review content regularly, there may be times when inappropriate or content is viewable before it can
          be removed
        </Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px", paddingLeft: "50px" }}>
          ...
          relation to any matters after such download. Third parties may comment on, link to, re-post, or otherwise deal
          with the user submitted content once it is submitted, and we do not accept any liability for such actions; and
        </Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px", paddingLeft: "50px" }}>
          Any personal information you provide about yourself, or the person/s appearing in user submitted content, may
          be used by Pedlar to conduct campaigns, research and marketing activities (including informing you about
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          To the extent permitted by law, Pedlar makes no warranty or representation regarding the standard of any goods
          or services to be supplied by a third-party seller on the site.
        </Typography>
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          ...
          contact the customer by email or via the message centre in your account to rectify the issue. If the customer
          does not contact us to resolve the issue within 48 hours, the order will be cancelled. Please note that stock
          availability and prices may change if the time between placing the order and credit card details being
          corrected or funds being available is delayed.
        </Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          ...
          transaction is unauthorised, (c) your method of payment cannot be processed at the time of any charge, or (d)
          any charge is disputed for any reason other than the undisputed failure by us to deliver the items purchased
          by you, we reserve the right to immediately terminate any pending transactions, suspend your account, thereby
          terminating all of our obligations to you under these Terms, and, in addition, to charge you an administrative
          processing fee equal to AUD$10, per instance, which charge you hereby authorise by entering into any
          transaction through the Sites.
        </Typography>
        <Typography sx={{ fontSize: "20px", fontWeight: 600, marginTop: "30px" }}>Privacy</Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          Your personal information will be collected, used and shared in accordance with the Pedlar Privacy Policy. By
          providing your personal information to us, you consent to the collection, use, storage and disclosure of that
          information as described in the Privacy Policy and these Terms. All users of Pedlar site may be subject to
          additional third-party Privacy Policies.
        </Typography>
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          We will provide you with delivery time frames and you may contact our customer service team directly to obtain
          an estimated delivery date and/or tracking information if not automatically provided to you following order
          confirmation. .Any delivery dates which may be specified on Pedlar are estimated dates only. You acknowledge
          that these delivery dates may vary and delays in delivery may be unavoidable.
        </Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          We will try to ensure that all orders are delivered in a prompt and timely manner. However, from time to time,
          it is possible that shipping and other factors outside of our control may result in delays. Pedlar does not
          accept any liability for loss or damage suffered by anyone as a result of any such delays.
        </Typography>
        <Typography sx={{ fontSize: "20px", fontWeight: 600, marginTop: "30px" }}>Shipping & Delivery</Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          All Brand Sellers on Pedlar provide efficient shipping service throughout Australia. Delivery and Shipping is
          organised by the brands directly and shipping costs may vary from brand to brand.
        </Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          How do I track my order? Once your order is on it’s way, will send you a shipment email containing a tracking
          link and details of your order.
        </Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          What are your Delivery timeframes? The standard delivery time is between 3-10 business days from when the
          order is placed. In the event that a product ordered is not available we will endeavour to notify you within 2
          business days to arrange an alternative product or a full refund.
        </Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          By submitting your request, you will receive an email with a returns address label and further instructions to
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          ...
          Service team on hello@pedlar.store or through your account. We will coordinate a response from the third-party
          seller and will resolve any dispute in accordance with the Australian Consumer Law, this may include, at our
          sole discretion, replacing or repairing the product or refunding you the price of the product to your original
          payment method.
        </Typography>
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          Pedlar will not be liable for any loss or damage caused by a distributed denial-of-service attack, viruses or
          other technologically harmful material that may infect your computer equipment, computer programs, data or
          other proprietary material due to your use of this Site or to your downloading of any material posted on it,
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          ...
          to) override any rights that you have pursuant to applicable law, including the Australian Consumer Law.
          Pedlar and its related body corporates (as applicable) provide, and you accept that:
        </Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px", paddingLeft: "50px" }}>
          1. We make no representations, warranties or guarantees of any kind, express or implied as to the operation of
          our Sites or the information, content, materials or products included on our Sites, except as otherwise
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px", paddingLeft: "50px" }}>
          4. By continuing to access our Sites you agree that your access to, and use of, them is subject to these terms
          and all applicable laws, and is at your own risk.
        </Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px", paddingLeft: "50px" }}>
          5. Our Site and its content is provided to you on “as is” basis; our Sites may contain errors and inaccuracies
          and may not be complete or current. We cannot guarantee our Sites will always be available or fault- or virus-
          free
        </Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px", paddingLeft: "50px" }}>
          6. Pedlar is an online platform where you may purchase products from Brand Sellers via Creator’s storefronts.
          Pedlar acts as a limited agent for the Brand Seller, the Creator and yourself in order to: (a) facilitate the
          sale and purchase of products; (b) collect payment from you and then remit payment to the Seller and Creator;
          and (c) provide associated support services in relation to the sale and purchase of products, We will not be a
          party to or in any way be responsible for monitoring any transaction between a Seller and yourself and
          therefore do not warrant, endorse, guarantee or assume responsibility for any product advertised or offered by
          a Seller through the Sites.
        </Typography>
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px", paddingLeft: "50px" }}>
          7. Pedlar and its related body corporates expressly disclaim all liability for any act or omission of you, any
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px" }}>
          ...
          and construed in accordance with the laws of the State of New South Wales without reference to conflict of law
          principles. These Terms will not be assignable or transferable by you without our prior written consent
        ...
        <Typography sx={{ fontSize: "16px", fontWeight: 400, marginTop: "20px", marginBottom: "50px" }}>
          ...
          regarding its subject matter. No failure or delay by a party in exercising any right, power or privilege under
          these Terms will operate as a waiver thereof, nor will any single or partial exercise of any right, power or
          privilege preclude any other or further exercise thereof or the exercise of any other such right, power, or
          privilege. The invalidity or unenforceability of any provision of these Terms will not affect the validity or
          enforceability of any other provision of these Terms, all of which will remain in full force and effect.
        </Typography>
      </Box>
    </Fragment>
  );
