    ...
    <CustomContainer>
      <Box sx={styles.MainBox}>
        ...
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          These are the Terms and Conditions referred to in the Pedlar Store Pty Ltd (ACN 655 606 250) (Pedlar)
          Platform.
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          You agree that by using the Pedlar Platform and/or by pressing ‘Yes’/’I accept/Submit‘, these Terms and
        ...
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.haedingOne}>
          ...
          rights in computer software, database rights, topography rights, rights in confidential information (including
        ...
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          You agree to provide certain personal information to Pedlar as a condition of use of the Pedlar Platform, such
          as your:
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (1) name;
        ...
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (4) other information as might be required by Pedlar from time to time, including bank details, address and
          tax status. (together, the Information)
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
        ...
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          ...
          (including without limitation, any taxation laws) and you hereby indemnify Pedlar for any special incidental,
          indirect, statutory, exemplary, punitive or consequential damages, including loss of profits, arising out of,
          or in any way related to the inaccuracy of the Information.
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
        ...
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          Pedlar shall not be liable to you for any damages of any kind arising out of your use of the Pedlar Platform,
          whether such damage arises directly or indirectly. You agree and understand that the use of the Pedlar
          Platform is undertaken at your own risk.
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          <b>7.2 Indemnity</b>
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          You agree to indemnify and hold harmless, Pedlar, its employees, personnel and agents from any and all claims,
          liabilities, damages, losses and expenses arising out of or in any way connected with any of the following
          matters:
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
        ...
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (6)any of the warranties and undertakings you have given under this Agreement; whether such matters are
        ...
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (a) that you are and will be the sole author of all Materials produced by you in the course of providing
          Services which will be wholly original to you, and not in breach of the rights of any third party, including
          but not limited to, any IPR;
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (b) you are in compliance with all relevant Laws in the Jurisdiction and any regulations or guidance notes
          issued pursuant to or in connection with those Laws and will continue to comply with same;
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (c) you will follow any best practice guidelines endorsed by Pedlar and notified to you from time to time;
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (d) you will not do anything which would defame, tend to defame or could be construed as being defamatory,
          derogatory or disparaging of Pedlar or any brand or their aﬃliates;
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (e) any Materials you produce:
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (i) will be your sole and original work, unless collaboration is necessary or implied, in which case it will
          be the original work of you and any collaborators;
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
        ...
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (v) will not be obscene, graphic, pornographic, racially or religiously insensitive or in any way
          discriminatory or offensive, or with the tendency to offend;
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (f) you will not post any obscene, graphic, racially or religiously insensitive or any otherwise
          discriminatory or content which is offensive or might tend to offend any person, or do any other thing which
          might have the tendency to offend any person; and
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (2) you represent and warrant that:
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (a) you have not taken any fraudulent action, or procured that any fraudulent action is taken in relation to
          your social media channels (including, but not limited to, Facebook, Instagram, Twitter, Tiktok or blog).
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          <b>8.2 Exclusivity</b>
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          ...
          Pedlar in providing services similar to Pedlar, so long as you are signed up for the Pedlar Platform and for a
          period of 3 months following you removing yourself from the Pedlar Platform.
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
        ...
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (1) you agree to not publish any material, whether in print or electronically, make any statement or do any
          other thing which may tend to defame or bring into disrepute, Pedlar or any brand, product or person/party on
          the Pedlar Platform, or otherwise say or do anything that is adverse or prejudicial to Pedlar or a brand, or
          permit any such thing to be done on your behalf; and
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (2) you agree to indemnify Pedlar for any costs, losses or liabilities arising out of a breach of paragraph
          8.3(1) by you.
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
        ...
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          ...
          Platform. If you are in breach of this Agreement or Pedlar suspects that you are in breach of this Agreement,
          or engaged in suspicious, fraudulent, abusive or other activity which Pedlar (in its absolute and exclusive
          discretion) determines is not in accordance with its values or may be detrimental to its or a brand’s
          interests it may choose to suspend or terminate your access to the Pedlar Platform.
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          <b>9. General</b>
        </Typography>
        ...
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          Despite any other provision of this agreement, if a party is unable to perform or is delayed in performing an
          obligation under this agreement by reason of a Force Majeure Event:
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (1) that obligation is suspended but only so far and for so long as it is affected by the Force Majeure Event;
          and
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          (2) the affected party will not be responsible for any loss or expense suffered or incurred by any other party
          as a result of, and to the extent that, the affected party is unable to perform or is delayed in performing
          its obligations because of the Force Majeure Event.
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          <b>9.2 No waiver</b>
        </Typography>
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          No forbearance or delay by Pedlar in exercising or enforcing its rights under the Agreement shall prejudice or
          restrict the rights of Pedlar to exercise or enforce its rights at a later time and no waiver of any such
        ...
        <Typography textTransform={"none"} fontSize={"16px"} fontWeight={"400"} sx={styles.spacing}>
          This Agreement is governed by the laws of New South Wales and each party submits to the exclusive jurisdiction
          of the courts of New South Wales and any courts which have jurisdiction to hear appeals from any of those
