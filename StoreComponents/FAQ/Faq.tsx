        ...
        <Grid item xs={12} sm={12} md={12} lg={6}>
          <Accordion expanded={expanded === "panel1"} onChange={handleChange("panel1")}>
            <AccordionSummary
              ...
              id="panel1bh-header"
            >
              <Typography>Why should I set up a Pedlar store?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>
          ...
          <Accordion expanded={expanded === "panel3"} onChange={handleChange("panel3")}>
            <AccordionSummary
              ...
              id="panel3bh-header"
            >
              <Typography>Does it cost to join Pedlar?</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <Typography>Nope! It's completely free for both Creators and Brands.</Typography>
            </AccordionDetails>
          </Accordion>
          ...
          <Accordion expanded={expanded === "panel5"} onChange={handleChange("panel5")}>
            ...
            <AccordionDetails>
              <Typography>Yep, when signing up you can choose your own unique URL.</Typography>
            </AccordionDetails>
          </Accordion>
        </Grid>
      </Grid>
